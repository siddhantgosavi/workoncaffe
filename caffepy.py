...
for x in range(101,1000,2):
	...
	inputImage = input('Enter image path : ')#("/home/user/Desktop/vidimg/00"+str(x)+".jpg")#
	...
	print("image "+str(x)+" saved in colored")

for x in range(1001,1523,2):

	inputImage = ("/home/user/Desktop/vidimg/0"+str(x)+".jpg")#input('Enter image path : ')
	outputImage = inputImage.split('/')[-1]
	print("image conversion started")
